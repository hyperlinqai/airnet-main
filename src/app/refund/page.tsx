...
const RefundPage = () => {
  const policies = [
    ...
    },
    {
      ...
      content: 'Syntego Telemedia Private Limited does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.'
    },
    {
    ...
    },
    {
      ...
      icon: <Clock className="w-6 h-6 text-blue-500" />,
      content: 'In case of any Refunds approved by the Syntego Telemedia Private Limited, it\'ll take 3-5 days for the refund to be processed to the end customer.'
    }
  ];
        ...
        <div className="space-y-12">
          ...
          <div className="prose max-w-none">
            <p className="text-lg text-gray-600 leading-relaxed">
              Syntego Telemedia Private Limited believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
            </p>
          </div>
